...
const App: React.FC = () => {
  let tcpData = require("../[data]/m4/GeeToPi.json");
  const searchParams = useSearchParams();

  let file = searchParams.get("file");
  if (file === "GeeToPi") {
    tcpData = require("../[data]/m4/GeeToPi.json");
  } else if (file == "localToGee") {
    tcpData = require("../[data]/m4/localToGee.json");
  } else if (file == "localTolocal") {
    tcpData = require("../[data]/m4/localTolocal.json");
  } else {
    file = "localToPi";
    tcpData = require("../[data]/m4/localToPi.json");
  }
  ...
  return (
    <div style={{ width: "80%", margin: "50px auto" }}>
      <h1>UDP Throughput Graph: {file}</h1>
